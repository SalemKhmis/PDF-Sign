<script>
  ...
  onMount(() => {
    handleScreenWidth(); // Initial check
    window.addEventListener("resize", handleScreenWidth); // Listen for resize events
  ...
  <style>
    ...
    .menu-item:hover {
        color: #38a53d; /* Change icon color on hover */
    }
    .active_item{
    ...
    <div  class={`menu-item ${activeOnglet==1 ? 'active_item' : ''}`} on:click={handleSignClick}>
        <i class="mr-2">
            <svg width="19" height="19" viewBox="0 0 19 19" fill={activeOnglet==1 ? '#3CA939' : '#BCBCBC'} xmlns="http://www.w3.org/2000/svg">
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M12.6087 0.68016C13.5155 -0.22672 14.9859 -0.22672 15.8927 0.68016L17.2681 2.0555C18.175 2.96238 18.175 4.43272 17.2681 5.33961L14.8959 7.71185L6.55268 16.055C6.39118 16.2165 6.18166 16.3214 5.95556 16.3537L2.26112 16.8814C1.93222 16.9284 1.60038 16.8178 1.36545 16.5828C1.13052 16.3479 1.01991 16.0161 1.06689 15.6872L1.59467 11.9927C1.62697 11.7666 1.73173 11.5571 1.89322 11.3956L10.311 2.97784L12.6087 0.68016Z" fill="#3BA83A"/>
...
>
    ...
    <div  class="block_icon"  on:click={() => menu = false}>
      <div class="icon_left">
        <svg width="9" height="18" viewBox="0 0 9 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M7.28758 17.7501C7.10084 17.7507 6.91633 17.7095 6.7476 17.6295C6.57888 17.5494 6.43023 17.4326 6.31258 17.2876L0.275083 9.7876C0.0912304 9.56393 -0.00927734 9.28338 -0.00927734 8.99385C-0.00927734 8.70432 0.0912304 8.42377 0.275083 8.2001L6.52508 0.700101C6.73725 0.44483 7.04214 0.284299 7.37268 0.253825C7.70321 0.22335 8.03231 0.325427 8.28758 0.5376C8.54285 0.749774 8.70338 1.05466 8.73386 1.3852C8.76433 1.71573 8.66225 2.04483 8.45008 2.3001L2.86258 9.0001L8.26258 15.7001C8.41543 15.8836 8.51253 16.107 8.54238 16.3439C8.57223 16.5809 8.53358 16.8214 8.43101 17.0371C8.32844 17.2527 8.16624 17.4345 7.96361 17.5609C7.76097 17.6872 7.52637 17.7529 7.28758 17.7501Z" fill="#7D7E7E"/>
          </svg>
      </div>
    </div>
  </div>
  ...
  <div class="left-menu2">
    ...
    <div class="menu-item " style="place-content: center;" on:click={handleSignClick}>
        <i class="mr-4">
            <svg width="19" height="19" viewBox="0 0 19 19" fill={activeOnglet==1 ? '#3CA939' : '#BCBCBC'} xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M0 17.9474C0 17.3644 0.472593 16.8918 1.05556 16.8918H17.9444C18.5274 16.8918 19 17.3644 19 17.9474C19 18.5304 18.5274 19.003 17.9444 19.003H1.05556C0.472593 19.003 0 18.5304 0 17.9474Z" fill={activeOnglet==1 ? '#3CA939' : '#BCBCBC'}/>
                <path fill-rule="evenodd" clip-rule="evenodd" d="M12.6087 0.68016C13.5155 -0.22672 14.9859 -0.22672 15.8927 0.68016L17.2681 2.0555C18.175 2.96238 18.175 4.43272 17.2681 5.33961L14.8959 7.71185L6.55268 16.055C6.39118 16.2165 6.18166 16.3214 5.95556 16.3537L2.26112 16.8814C1.93222 16.9284 1.60038 16.8178 1.36545 16.5828C1.13052 16.3479 1.01991 16.0161 1.06689 15.6872L1.59467 11.9927C1.62697 11.7666 1.73173 11.5571 1.89322 11.3956L10.311 2.97784L12.6087 0.68016Z" fill={activeOnglet==1 ? '#3CA939' : '#BCBCBC'}/>
                <rect x="9.40576" y="3.87769" width="1.40741" height="6.59405" transform="rotate(-44.9444 9.40576 3.87769)" fill={activeOnglet==1 ? '#3CA939' : '#BCBCBC'}/>
            </svg>
        </i>
    </div>
    <div  class={`menu-item ${activeOnglet==5 ? 'active_item' : ''}`} style="place-content: center;" on:click={handleInitialsClick}>
      <!-- <i class="mr-4">
        <svg width="23" height="13" viewBox="0 0 23 13" fill={activeOnglet==3 ? '#3CA939' : '#BCBCBC'} xmlns="http://www.w3.org/2000/svg">
            <path d="M22.4031 4.33365C20.5409 4.45213 17.8842 6.1854 16.5396 6.75413C15.4935 7.19761 14.5911 7.58015 13.8038 7.58015C12.9914 7.58015 12.8691 7.03173 13.0381 5.82318C13.0777 5.55235 13.4587 3.14203 11.503 3.24697C10.6007 3.29775 9.19145 4.08652 5.40951 7.51244L6.90143 4.00189C7.99431 1.43245 4.98889 -1.12683 2.23871 0.521809L0.265055 1.77098C-0.000975466 1.93009 -0.0800656 2.26523 0.0888996 2.51913L0.70724 3.43316C0.876206 3.68706 1.23211 3.76153 1.50174 3.59904L3.58684 2.28216C4.24832 1.88608 5.05001 2.5259 4.76241 3.19958L1.23211 11.5139C0.987651 12.086 1.32918 13 2.29983 13C2.59821 13 2.893 12.8917 3.1123 12.6818C4.62939 11.2532 8.67377 7.58015 10.7049 6.05338C10.6259 7.01819 10.6295 8.04732 11.4455 8.89025C11.9956 9.45898 12.7865 9.74673 13.8002 9.74673C15.0801 9.74673 16.2449 9.25248 17.4779 8.73114C18.6643 8.23012 21.037 6.61195 22.4534 6.50362C22.759 6.47993 22.9999 6.2565 22.9999 5.96875V4.88207C23.0071 4.57401 22.7302 4.31334 22.4031 4.33365Z" fill={activeOnglet==3 ? '#3CA939' : '#BCBCBC'}/>
            </svg>
    </i> -->
    <span style="margin-right: 10px;color: #BCBCBC;font-weight: bold;">AB</span>
  </div>
    <div class="menu-item" style="place-content: center;" on:click={handleManuelleClick}>
        <i class="mr-4">
            <svg width="23" height="13" viewBox="0 0 23 13" fill={activeOnglet==2 ? '#3CA939' : '#BCBCBC'} xmlns="http://www.w3.org/2000/svg">
                <path d="M22.4031 4.33365C20.5409 4.45213 17.8842 6.1854 16.5396 6.75413C15.4935 7.19761 14.5911 7.58015 13.8038 7.58015C12.9914 7.58015 12.8691 7.03173 13.0381 5.82318C13.0777 5.55235 13.4587 3.14203 11.503 3.24697C10.6007 3.29775 9.19145 4.08652 5.40951 7.51244L6.90143 4.00189C7.99431 1.43245 4.98889 -1.12683 2.23871 0.521809L0.265055 1.77098C-0.000975466 1.93009 -0.0800656 2.26523 0.0888996 2.51913L0.70724 3.43316C0.876206 3.68706 1.23211 3.76153 1.50174 3.59904L3.58684 2.28216C4.24832 1.88608 5.05001 2.5259 4.76241 3.19958L1.23211 11.5139C0.987651 12.086 1.32918 13 2.29983 13C2.59821 13 2.893 12.8917 3.1123 12.6818C4.62939 11.2532 8.67377 7.58015 10.7049 6.05338C10.6259 7.01819 10.6295 8.04732 11.4455 8.89025C11.9956 9.45898 12.7865 9.74673 13.8002 9.74673C15.0801 9.74673 16.2449 9.25248 17.4779 8.73114C18.6643 8.23012 21.037 6.61195 22.4534 6.50362C22.759 6.47993 22.9999 6.2565 22.9999 5.96875V4.88207C23.0071 4.57401 22.7302 4.31334 22.4031 4.33365Z" fill={activeOnglet==2 ? '#3CA939' : '#BCBCBC'}/>
                </svg>
    ...
    <div  class="block_icon" style="left: 8%!important;"  on:click={() => menu = true}>
      <div class="icon_left">
        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M12.7124 6.2499C12.8992 6.24926 13.0837 6.29048 13.2524 6.37052C13.4211 6.45055 13.5698 6.56738 13.6874 6.7124L19.7249 14.2124C19.9088 14.4361 20.0093 14.7166 20.0093 15.0061C20.0093 15.2957 19.9088 15.5762 19.7249 15.7999L13.4749 23.2999C13.2627 23.5552 12.9579 23.7157 12.6273 23.7462C12.2968 23.7767 11.9677 23.6746 11.7124 23.4624C11.4571 23.2502 11.2966 22.9453 11.2661 22.6148C11.2357 22.2843 11.3377 21.9552 11.5499 21.6999L17.1374 14.9999L11.7374 8.2999C11.5846 8.11642 11.4875 7.89299 11.4576 7.65606C11.4278 7.41912 11.4664 7.17859 11.569 6.96293C11.6716 6.74727 11.8338 6.56551 12.0364 6.43914C12.239 6.31278 12.4736 6.24711 12.7124 6.2499Z" fill="#7D7E7E"/>
          </svg>          
      </div>
    </div>
  </div>
